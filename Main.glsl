...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) {   
    ...
    */
    int[] ceros = int[](0xF99F, 0x6996, 0x2552, 0x7557), unos = int[](0x1111, 0x3111, 0x1311, 0x6227, 0x2627);
    //int[] nums = int[](0xF99F, 0x1111); 
    
        
    int dec = ceros[int(iTime) % ceros.length()]; //unos[int(iTime) % unos.length()]; //nums[1]; //int(iTime) % nums.length()]; //int(iTime) % 0xFFFF; //0xF99F;   
